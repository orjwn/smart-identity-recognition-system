"""
Project wrapper for FocusFace.

Status: project wrapper/integration code.
External dependency/reference: NetoPedro/FocusFace.
Student contribution: connects the external FocusFace model implementation to
this project's aligned-face, embedding, backend and evaluation pipeline.

This file imports the external FocusFace model implementation from
external/FocusFace and exposes a stable embedding API for this project's
backend and evaluation scripts.

External reference:
- https://github.com/NetoPedro/FocusFace
